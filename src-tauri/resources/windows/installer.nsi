...
XPStyle on
BGGradient 0B1224 070E1D FFFFFF
InstallColors DDE5FF 070E1D
...
!if "${SIDEBARIMAGE}" != ""
  ...
  ; Note: installer-sidebar.bmp must be in bottom-up DIB format (positive height) for NSIS compatibility.
  ; If the bitmap appears distorted or shows a fullscreen background, re-export it as a standard bottom-up BMP.
!endif
...
!define MUI_BGCOLOR "070E1D"
!define MUI_TEXTCOLOR "DDE5FF"
...
!define MUI_DIRECTORYPAGE_TEXT_TOP "Choose where SSH Tunnel Manager should live on this device."
!define MUI_DIRECTORYPAGE_TEXT_DESTINATION "Install location"
!define MUI_STARTMENUPAGE_TEXT_TOP "Choose how SSH Tunnel Manager should appear in the Start menu."
!define MUI_INSTFILESPAGE_ABORTHEADER_TEXT "Installation interrupted"
!define MUI_INSTFILESPAGE_ABORTHEADER_SUBTEXT "SSH Tunnel Manager was not fully installed."
!define MUI_FINISHPAGE_TITLE "Ready to launch."
!define MUI_FINISHPAGE_TITLE_3LINES
!define MUI_FINISHPAGE_TEXT "SSH Tunnel Manager is installed. Open the app now, or create a desktop shortcut for quick access."
...
Function PageReinstall
  ...
  ${Else}
    ...
    Pop $R1
    SendMessage $R1 ${WM_SETTEXT} 0 "STR:$R1"
